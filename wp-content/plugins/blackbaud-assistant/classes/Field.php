...
abstract class Field extends Core {
    ...
    public function render() {
        echo $this->plugin->blackbaud->plugin->get_template($this->template, $this->get_field_data());
    }

    public function rendering() {
        return $this->plugin->blackbaud->plugin->get_template($this->template, $this->get_field_data());
    }
