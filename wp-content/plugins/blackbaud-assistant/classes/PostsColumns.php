...
class PostsColumns extends Core {
    ...
    public function values($column, $post_id) {
        if (isset($this->columns[$column])) {
            ...
            if (isset($callback) && is_callable($callback)) {
                echo call_user_func_array($callback, array(
                    $atts
                ));
            } else {
                echo "";
    ...
    protected function start() {
        add_action("manage_" . $this->post_type . "_posts_columns", array(
            $this,
            "manager"
        ));
        ...
        add_filter("manage_edit-" . $this->post_type . "_sortable_columns", array(
            $this,
            "sortable"
        ));
